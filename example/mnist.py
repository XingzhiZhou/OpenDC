'''
This code is after  'https://github.com/vlukiyanov/pt-dec/blob/master/examples/mnist/mnist.py'
Some modifications are applied in this python file.
'''
    ...
    def __getitem__(self, index: int) -> torch.Tensor:
        if index not in self._cache:
            ...
            if self.cuda:
                ...
                self._cache[index][1] = torch.tensor(self._cache[index][1], dtype=torch.long)
